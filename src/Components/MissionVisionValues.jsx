    ...
    <div className="mission-vision-container">
      ...
      <div className="content-section">
        <p className="introduction">
          Compass Group is a global family of companies with personal values.
          The daily interactions our customers, clients, and suppliers engage in are guided by our goal to deliver enriching and sustainable service without compromise. Our values are simple but essential to our success.
        </p>

        <section>
          <h2 className="section-heading">Our Mission</h2>
          <p>
            Everyone associated with Compass Group is committed to consistently delivering superior service in the most efficient way, for the shared benefit of our customers, shareholders, and associates.
          </p>
        </section>
        ...
        <section>
          ...
          <p><b>Insider</b></p>
          <p>
            The Insiders are wired to their ecosystem and influence it proactively and positively.
          </p>
          <p><b>Problem Solver</b></p>
          <p>
            The Problem Solvers look at every obstacle as an opportunity to do something new, like never before.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            The Code of Business Conduct sets out our commitment to conduct business fairly by treating everyone – customers, colleagues, investors, suppliers, as well as the wider community – with honesty, integrity, and respect.
          </p>
          <p>
            Every individual in Compass Group shares the responsibility to work to the standards set out in the Code of Business Conduct and to conduct our business in a professional, safe, ethical, and responsible manner. This is without exception or compromise. The Code of Business Conduct brings together our policies on compliance and ethical issues and is to be followed by all employees across the Group.
          </p>
          <p>
            The Code of Business complements Compass Group’s Code of Ethics, which helps our people understand their role in protecting and building our reputation.
          </p>
          <p>
            We value and foster a culture of integrity based on principles of Openness, Trust and Accountability and uphold our high ethical standards in accordance with our Values, Code of Business Conduct, Compass Group Code of Ethics and our Speak and Listen Up Policy. Click here for details of our <a href="#">Speak and Listen Up Policy</a>.
          </p>
        </section>
      </div>
    </div>
