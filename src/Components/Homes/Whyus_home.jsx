...
const Whyus_home = () => {
  return (
    <div className="whyus-page-wrapper">
      <div className="whyus-containerr scale-in">
        <div className="content-wrapper">
          <p className="descriptionn fade-in-up">
          ...
          <div className="services-grid">
            <div className="service-item fade-in-up stagger-1">
            ...
            <div className="service-item fade-in-up stagger-2">
              <div className="icon-image">
            ...
            <div className="service-item fade-in-up stagger-3">
              <div className="icon-image">
            ...
            <div className="service-item fade-in-up stagger-4">
              <div className="icon-image">
