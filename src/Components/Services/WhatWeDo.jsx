...
function WhatWeDo() {
  ...
  // FIXED: Better scroll handling with improved timing and positioning
  useEffect(() => {
    // Function to handle smooth scrolling with better positioning
    ...
    // Check for scroll targets in sessionStorage with improved logic
    const scrollTargets = [
    ...
    scrollTargets.forEach(({ key, sectionId }) => {
    ...
    // Also handle URL hash-based scrolling (if you're using hash routing)
